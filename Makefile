...
bash: build
	docker run --rm -it --gpus all -v $(cur_dir)/models:/opt/big_transfer_models:ro -v $(cur_dir)/datasets:/root/tensorflow_datasets --entrypoint /bin/bash ${IMAGE_NAME}:${IMAGE_VER}
